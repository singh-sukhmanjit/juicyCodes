...
<!-- ************ -->
            ...
            <div class="row changeContent">
                <div class="col-sm-12 uploadVideo">
                    <div class="panelHead">
                        <span>FIREWALL SETTINGS</span> <a data-toggle="collapse" data-target="#toggleNewServer" href="javascript:void"><i class="pull-right fa fa-angle-up"></i></a>
                    </div>
                    ...
                    <div class="panelBody collapse in" id="toggleNewServer">
                        <div class="newServer col-sm-5">
                            <form>
                                ...
                                <div class="form-group col-sm-6">
                                    <label>Block Single IP/Subnet: </label>
                                    <textarea class="form-control"></textarea>
                                </div>
                                <div class="form-group col-sm-6">
